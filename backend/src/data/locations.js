...
const rwandaLocations = {
  ...
  districts: [
    ...
    { id: "11", provinceId: "1", name: "Gasabo" },
    { id: "12", provinceId: "1", name: "Kicukiro" },
    { id: "13", provinceId: "1", name: "Nyarugenge" },
    // Eastern Province (Province ID: 2)
    { id: "21", provinceId: "2", name: "Bugesera" },
    { id: "22", provinceId: "2", name: "Gatsibo" },
    { id: "23", provinceId: "2", name: "Kayonza" },
    { id: "24", provinceId: "2", name: "Kirehe" },
    { id: "25", provinceId: "2", name: "Ngoma" },
    { id: "26", provinceId: "2", name: "Nyagatare" },
    { id: "27", provinceId: "2", name: "Rwamagana" },
    // Northern Province (Province ID: 3)
    { id: "31", provinceId: "3", name: "Burera" },
    { id: "32", provinceId: "3", name: "Gakenke" },
    { id: "33", provinceId: "3", name: "Gicumbi" },
    { id: "34", provinceId: "3", name: "Musanze" },
    { id: "35", provinceId: "3", name: "Rulindo" },
    // Southern Province (Province ID: 4)
    { id: "41", provinceId: "4", name: "Gisagara" },
    { id: "42", provinceId: "4", name: "Huye" },
    { id: "43", provinceId: "4", name: "Kamonyi" },
    { id: "44", provinceId: "4", name: "Muhanga" },
    { id: "45", provinceId: "4", name: "Nyamagabe" },
    { id: "46", provinceId: "4", name: "Nyanza" },
    { id: "47", provinceId: "4", name: "Nyaruguru" },
    { id: "48", provinceId: "4", name: "Ruhango" },
    // Western Province (Province ID: 5)
    { id: "51", provinceId: "5", name: "Karongi" },
    { id: "52", provinceId: "5", name: "Ngororero" },
    { id: "53", provinceId: "5", name: "Nyabihu" },
    { id: "54", provinceId: "5", name: "Nyamasheke" },
    { id: "55", provinceId: "5", name: "Rubavu" },
    { id: "56", provinceId: "5", name: "Rusizi" },
    { id: "57", provinceId: "5", name: "Rutsiro" },
  ],
  ...
  nationalities: [
    ...
    { id: "AD", name: "Andorran" },
    { id: "AO", name: "Angolan" },
    { id: "AG", name: "Antiguan and Barbudan" },
    ...
    { id: "BS", name: "Bahamian" },
    { id: "BH", name: "Bahraini" },
    { id: "BD", name: "Bangladeshi" },
    { id: "BB", name: "Barbadian" },
    { id: "BY", name: "Belarusian" },
    { id: "BE", name: "Belgian" },
    { id: "BZ", name: "Belizean" },
    { id: "BJ", name: "Beninese" },
    { id: "BT", name: "Bhutanese" },
    { id: "BO", name: "Bolivian" },
    { id: "BA", name: "Bosnian and Herzegovinian" },
    { id: "BW", name: "Motswana" },
    { id: "BR", name: "Brazilian" },
    { id: "GB", name: "British" },
    { id: "BN", name: "Bruneian" },
    { id: "BG", name: "Bulgarian" },
    { id: "BF", name: "Burkinabe" },
    { id: "BI", name: "Burundian" },
    { id: "CV", name: "Cabo Verdean" },
    { id: "KH", name: "Cambodian" },
    { id: "CM", name: "Cameroonian" },
    { id: "CA", name: "Canadian" },
    { id: "CF", name: "Central African" },
    { id: "TD", name: "Chadian" },
    { id: "CL", name: "Chilean" },
    { id: "CN", name: "Chinese" },
    { id: "CO", name: "Colombian" },
    { id: "KM", name: "Comoran" },
    { id: "CG", name: "Congolese (Congo-Brazzaville)" },
    { id:"CD", name:"Congolese (DRC)"},
    { id: "CR", name: "Costa Rican" },
    { id: "HR", name: "Croatian" },
    { id: "CU", name: "Cuban" },
    { id: "CY", name: "Cypriot" },
    { id: "CZ", name: "Czech" },
    { id: "DK", name: "Danish" },
    { id: "DJ", name: "Djibouti" },
    { id: "DM", name: "Dominican" },
    { id: "NL", name: "Dutch" },
    { id: "TL", name: "East Timorese" },
    { id: "EC", name: "Ecuadorean" },
    { id: "EG", name: "Egyptian" },
    { id: "SV", name: "Salvadoran" },
    { id: "GQ", name: "Equatorial Guinean" },
    { id: "ER", name: "Eritrean" },
    { id: "EE", name: "Estonian" },
    ...
    { id: "GH", name: "Ghanaian" },
    { id: "GR", name: "Greek" },
    { id: "GD", name: "Grenadian" },
    { id: "GT", name: "Guatemalan" },
    { id: "GN", name: "Guinean" },
    { id: "GW", name: "Guinea-Bissauan" },
    { id: "GY", name: "Guyanese" },
    { id: "HT", name: "Haitian" },
    { id: "HN", name: "Honduran" },
    { id: "HU", name: "Hungarian" },
    { id: "IS", name: "Icelander" },
    { id: "IN", name: "Indian" },
    ...
    { id: "JM", name: "Jamaican" },
    { id: "JP", name: "Japanese" },
    { id: "JO", name: "Jordanian" },
    { id: "KZ", name: "Kazakhstani" },
    { id: "KE", name: "Kenyan" },
    { id: "KI", name: "I-Kiribati" },
    { id: "KW", name: "Kuwaiti" },
    { id: "KG", name: "Kyrgyz" },
    { id: "LA", name: "Laotian" },
    { id: "LV", name: "Latvian" },
    ...
    { id: "LR", name: "Liberian" },
    { id: "LY", name: "Libyan" },
    { id: "LI", name: "Liechtensteiner" },
    { id: "LT", name: "Lithuanian" },
    { id: "LU", name: "Luxembourger" },
    { id: "MK", name: "Macedonian" },
    { id: "MG", name: "Malagasy" },
    { id: "MW", name: "Malawian" },
    { id: "MY", name: "Malaysian" },
    { id: "MV", name: "Maldivan" },
    { id: "ML", name: "Malian" },
    { id: "MT", name: "Maltese" },
    { id: "MH", name: "Marshallese" },
    { id: "MR", name: "Mauritanian" },
    { id: "MU", name: "Mauritian" },
    { id: "MX", name: "Mexican" },
    { id: "FM", name: "Micronesian" },
    { id: "MD", name: "Moldovan" },
    { id: "MC", name: "Monacan" },
    { id: "MN", name: "Mongolian" },
    { id: "ME", name: "Montenegrin" },
    { id: "MA", name: "Moroccan" },
    { id: "MZ", name: "Mozambican" },
    { id: "MM", name: "Myanmar (Burmese)" },
    { id: "NA", name: "Namibian" },
    { id: "NR", name: "Nauruan" },
    { id: "NP", name: "Nepalese" },
    { id: "NZ", name: "New Zealander" },
    { id: "NI", name: "Nicaraguan" },
    { id: "NE", name: "Nigerien" },
    { id: "NG", name: "Nigerian" },
    { id: "KP", name: "North Korean" },
    { id: "NO", name: "Norwegian" },
    { id: "OM", name: "Omani" },
    { id: "PK", name: "Pakistani" },
    { id: "PW", name: "Palauan" },
    { id: "PS", name: "Palestinian" },
    { id: "PA", name: "Panamanian" },
    { id: "PG", name: "Papua New Guinean" },
    { id: "PY", name: "Paraguayan" },
    { id: "PE", name: "Peruvian" },
    { id: "PL", name: "Polish" },
    ...
    { id: "RU", name: "Russian" },
    { id: "RW", name: "Rwandan" },
    { id: "KN", name: "Kittian and Nevisian" },
    { id: "LC", name: "Saint Lucian" },
    { id: "VC", name: "Vincentian" },
    { id: "WS", name: "Samoan" },
    { id: "SM", name: "Sammarinese" },
    { id: "ST", name: "Sao Tomean" },
    { id: "SA", name: "Saudi" },
    { id: "SN", name: "Senegalese" },
    { id: "RS", name: "Serbian" },
    { id: "SC", name: "Seychellois" },
    { id: "SL", name: "Sierra Leonean" },
    { id: "SG", name: "Singaporean" },
    { id: "SK", name: "Slovak" },
    { id: "SI", name: "Slovenian" },
    { id: "SB", name: "Solomon Islander" },
    { id: "SO", name: "Somali" },
    { id: "ZA", name: "South African" },
    { id: "KR", name: "South Korean" },
    { id: "SS", name: "South Sudanese" },
    { id: "ES", name: "Spanish" },
    { id: "LK", name: "Sri Lankan" },
    { id: "SD", name: "Sudanese" },
    { id: "SR", name: "Surinamer" },
    { id: "SZ", name: "Swazi" },
    { id: "SE", name: "Swedish" },
    { id: "CH", name: "Swiss" },
    { id: "SY", name: "Syrian" },
    { id: "TW", name: "Taiwanese" },
    { id: "TJ", name: "Tadzhik" },
    { id: "TZ", name: "Tanzanian" },
    { id: "TH", name: "Thai" },
    { id: "TG", name: "Togolese" },
    { id: "TO", name: "Tongan" },
    { id: "TT", name: "Trinidadian or Tobagonian" },
    { id: "TN", name: "Tunisian" },
    { id: "TR", name: "Turkish" },
    { id: "TM", name: "Turkmen" },
    { id: "TV", name: "Tuvaluan" },
    ...
    { id: "AE", name: "Emirati" },
    { id: "UY", name: "Uruguayan" },
    { id: "UZ", name: "Uzbekistani" },
    { id: "VU", name: "Ni-Vanuatu" },
    { id: "VE", name: "Venezuelan" },
    { id: "VN", name: "Vietnamese" },
    { id: "YE", name: "Yemenite" },
    { id: "ZM", name: "Zambian" },
    { id: "ZW", name: "Zimbabwean" },
  ],
